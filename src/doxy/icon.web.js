...
class DoxyIcon extends Component {
  ...
  render() {
    if (this.props.name) {
      ...
      case 'Entypo':
        return <EntypoIcon name={this.props.name} size={24} style={this.props.style} />
      case 'EvilIcons':
        return <EvilIconsIcon name={this.props.name} size={24} style={this.props.style} />
      case 'Feather':
        return <FeatherIcon name={this.props.name} size={24} style={this.props.style} />
      case 'FontAwesome':
        return <FontAwesomeIcon name={this.props.name} size={24} style={this.props.style} />
      case 'Ionicons':
        return <IoniconIcon name={this.props.name} size={24} style={this.props.style} />
      case 'Material':
        return <MaterialIcon name={this.props.name} size={24} style={this.props.style} />
      default:
